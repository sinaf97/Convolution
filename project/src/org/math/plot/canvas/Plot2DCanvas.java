...
public class Plot2DCanvas extends PlotCanvas {
	...
	public Plot2DCanvas(int editable) {
		super();
		ActionMode = editable;
	}
	public Plot2DCanvas(Color c) {
		super(c);
		ActionMode = ZOOM;
	}
	...
	public Plot2DCanvas(double[] min, double[] max) {
		super(min, max);
		ActionMode = ZOOM;
	}
	public Plot2DCanvas(double[] min, double[] max,int editable) {
		super(min, max);
		ActionMode = editable;
	}
